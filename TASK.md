...
- [ ] **Ertelenen:** sahip 2-hesap canlı test (oluştur→listele→İlgileniyor; minör 18+ kanal etkinliğini görmez). Açık tamlık-kalemleri (sahip kararı): kart açıklaması düz-metin (markdown render yok) · derin link `?event=` açan handler yok
