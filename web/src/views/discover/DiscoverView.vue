...
<template>
  <!-- Ana içerik = yüzen panel (sol kolon = rail+DiscoverSidebar, AppShell gap-4'ten ayrı) -->
  <div
    class="flex flex-col flex-1 min-w-0 mt-4 mr-4 mb-4 rounded-[var(--kv-radius-lg)] overflow-hidden"
