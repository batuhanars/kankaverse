...
<template>
  <div ref="cardRef" class="relative z-10 px-2 pb-4 pt-4 shrink-0">
    ...
    >
      ...
      <div class="px-3 py-2.5 border-b flex items-center gap-2.5 opacity-40 cursor-not-allowed" style="border-color: var(--kv-border-subtle);">
        ...
        <span class="text-[12px]" style="color: var(--kv-text-muted);">{{ t('userCard.v2placeholder') }}</span>
      </div>
    ...
    >
      ...
      <!-- V2 ses ikonları (rezerve, devre dışı) -->
      <div class="flex items-center gap-1 shrink-0 opacity-20 pointer-events-none">
        <span class="w-7 h-7 flex items-center justify-center" style="color: var(--kv-text-muted);">
