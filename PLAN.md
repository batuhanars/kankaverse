...
- **C4 Video + Ekran Paylaşımı (YAYIN)** — ⚠️ **EN YÜKSEK ÇOCUK-GÜVENLİĞİ RİSKİ.** **Kurul verdict (2026-06-16): gating TASARIMI KİLİTLİ, BUILD ERTELENDİ.** Sözleşme `kurul/verdicts/2026-06-16-video-ekran-paylasimi.md`. Gerekçe: yetişkin-yalıtılmış-bağlam invariantı **self-declared yaşa** dayanıyor → en ağır CSAM vektörü için zemin zayıf → **yaş-doğrulama (e-Devlet/Sprint 8) + moderasyon kapasitesi (R1) önkoşul.** Tasarım rafta: ageGated/adultsOnly bağlam-only · minör=ASLA-video · flag-gated · kayıt-yok · karantina→video-yok · sunucu token-grant · screen≠kamera ayrımı. Build tetiği = lansman-hazırlığı.
