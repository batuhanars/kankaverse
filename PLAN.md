...
| 2B | Auth sertleştirme II: 2FA TOTP + kurtarma kodları, oturumlarım ekranı, hassas işlem reauth + e-posta değişimi, hesap silme (30 gün + legal-hold hook), zamanlanmış job (`@nestjs/schedule`) | brief §8. R7. Legal-hold tam enforce Report (Sprint 4) gelince; nihai KVKK onayı R6 |
